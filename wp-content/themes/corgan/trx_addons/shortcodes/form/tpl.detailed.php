		...
		?><div class="<?php echo esc_attr(trx_addons_get_column_class(1, 2)); ?>">
			<form class="sc_form_form <?php if ($form_style != 'default') echo 'sc_input_hover_'.esc_attr($form_style); ?>" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>"><?php
				...
				set_query_var('trx_addons_args_sc_form_field', array_merge($args, array(
					...
					'field_placeholder' => esc_html__('Enter your name', 'corgan')
				...
				set_query_var('trx_addons_args_sc_form_field', array_merge($args, array(
					...
					'field_placeholder' => esc_html__('Enter your e-mail', 'corgan')
				...
				set_query_var('trx_addons_args_sc_form_field', array_merge($args, array(
					...
					'field_placeholder' => esc_html__('Enter your message', 'corgan')
					
				)));
				if ($fdir != '') { include $fdir; }
				?>
				<div class="sc_form_field sc_form_field_button"><button class="sc_button inv_button sc_button_size_large"><?php esc_html_e('Send Message', 'corgan'); ?></button></div>
			...
			<div class="sc_form_info">
                ...
                if (!empty($args['address'])) {
                    ...
                    <div class="sc_form_info_item sc_form_info_item_address">
						<span class="sc_form_info_area">
							<span class="sc_form_info_title"><?php esc_html_e('Address:', 'corgan'); ?></span>
				...
				if (!empty($args['phone'])) {
					...
					<div class="sc_form_info_item sc_form_info_item_phone">
						<span class="sc_form_info_area">
							<span class="sc_form_info_title"><?php esc_html_e('Phone:', 'corgan'); ?></span>
							<span class="sc_form_info_data"><?php
                ...
                if (!empty($args['fax'])) {
                    $args['fax'] = explode('|', $args['fax']);
                    ?>
                    <div class="sc_form_info_item sc_form_info_item_fax">
						<span class="sc_form_info_area">
							<span class="sc_form_info_title"><?php esc_html_e('Fax:', 'corgan'); ?></span>
							<span class="sc_form_info_data"><?php
                                foreach ($args['fax'] as $item) {
                                    echo '<span>' . esc_html($item) . '</span>';
                                }
                                ?></span>
						</span>
				...
				if (!empty($args['email'])) {
					...
					<div class="sc_form_info_item sc_form_info_item_email">
						<span class="sc_form_info_area">
							<span class="sc_form_info_title"><?php esc_html_e('E-mail:', 'corgan'); ?></span>
						<span class="sc_form_info_data"><?php
