...
<a href="#" class="top_panel_cart_button" data-items="<?php echo esc_attr($cart_items); ?>" data-summa="<?php echo esc_attr($cart_summa); ?>">
	...
	<span class="contact_label contact_cart_label"><?php esc_html_e('cart:', 'corgan'); ?></span>
	<span class="contact_cart_totals">
		<span class="cart_items"><?php
			echo esc_html($cart_items) . ' ' . ($cart_items == 1 ? esc_html__('Item', 'corgan') : esc_html__('Items', 'corgan'));
		?></span><span class="cart_summa"><?php corgan_show_layout($cart_summa); ?></span>
	</span>
</a>
<ul class="widget_area sidebar_cart"><li>
	<?php
	do_action( 'before_sidebar' );
	corgan_storage_set('current_sidebar', 'cart');
